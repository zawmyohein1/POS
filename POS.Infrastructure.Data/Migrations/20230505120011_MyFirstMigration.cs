    ...
    public partial class MyFirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DbSuppliers", x => x.Supplier_ID);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 5, 5, 0, 0, 0, 0, DateTimeKind.Local), "admin@gmail.com", 1, false, "yngWIE500", "9484774", "", "admin" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "User_ID", "Created", "Email", "Gender", "IsDeleted", "Password", "Phone", "Role", "User_Name" },
                values: new object[] { 2, new DateTime(2023, 5, 5, 0, 0, 0, 0, DateTimeKind.Local), "user@gmail.com", 1, false, "yngWIE500", "7575664", "", "user" });
